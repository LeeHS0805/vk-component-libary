...
export var Button = function (props) {
    var _a;
    var btnType = props.btnType, disabled = props.disabled, size = props.size, className = props.className, href = props.href, children = props.children, restProps = __rest(props, ["btnType", "disabled", "size", "className", "href", "children"]);
